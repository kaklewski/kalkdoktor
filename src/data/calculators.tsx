...
const calculators: CalculatorModel[] = [
    {
        ...
        methodology: (
            <>
                <Text>
                    Wskaźnik masy ciała (BMI, ang. <em>Body Mass Index</em>)
                    oblicza się jako iloraz masy ciała i kwadratu wzrostu.
                </Text>
                <br />
                ...
                <UnorderedList>
                    <ListItem>
                        <strong>m</strong> – masa ciała wyrażona w kilogramach
                        (kg),
                    </ListItem>
                    <ListItem>
        ...
        sources: [
            {
                ...
                title: 'Badanie BMI',
                dateOfAccess: new Date('2024-09-20'),
...

    {
        ...
        form: [
            ...
            },
            {
                ...
                value: 1,
                label: 'Choroba naczyniowa (przebyty zawał serca, miażdżycowa choroba tętnic obwodowych, blaszki miażdżycowe w aorcie)',
            },
            {
                type: 'checkbox',
                name: 'stroke',
...

    {
        ...
        form: [
            {
                ...
                name: 'malignantTumor',
                value: 1,
                label: 'Nowotwór złośliwy (w trakcie leczenia lub rozpoznany w ciągu ostatnich 6 miesięcy)',
            },
            {
                type: 'checkbox',
                name: 'immobilization',
                value: 1,
                label: 'Porażenie, niedowład lub niedawne unieruchomienie kończyny dolnej w opatrunku gipsowym',
            },
            {
                type: 'checkbox',
                name: 'recentImmobilization',
                value: 1,
                label: 'Niedawne unieruchomienie w łóżku przez ponad 3 dni lub duża operacja w ciągu ostatnich 4 tygodni',
            },
            {
                type: 'checkbox',
                name: 'localPain',
            ...
            },
            {
                ...
                name: 'swellingCalf',
                value: 1,
                label: 'Obrzęk łydki ponad 3 cm w porównaniu do drugiej nogi (mierzony 10 cm poniżej guzowatości kości piszczelowej)',
            },
            {
                type: 'checkbox',
                name: 'pittingEdema',
        ...
        calculateResult(formValues) {
            ...
            if (result >= 3) {
                interpretation =
                    'Wysokie prawdopodobieństwo zakrzepicy żył głębokich.';
            } else if (result === 1 || result === 2) {
                interpretation =
                    'Średnie prawdopodobieństwo zakrzepicy żył głębokich.';
            } else {
                interpretation =
...

    {
        ...
        methodology: (
            <>
                <Text>
                    Liczbę opakowań leku niezbędnych do przeprowadzenia terapii
                ...
                <UnorderedList>
                    ...
                    <ListItem>
                        <strong>c</strong> – liczba tabletek w jednym
                        opakowaniu.
                    </ListItem>
                </UnorderedList>
                <br />
                <Text>
                    Uzyskany wynik należy zaokrąglić w górę do najbliższej
                    liczby całkowitej, aby zapewnić wystarczającą liczbę
                    tabletek na cały okres terapii.
                </Text>
            </>
        ),
        form: [
...

    {
        ...
        methodology: (
            <>
                <Text>
                    Maksymalna dobowa dawka paracetamolu jest obliczana na
                    podstawie masy ciała pacjenta i ograniczeń wiekowych.
                </Text>
                <br />
                ...
                <UnorderedList>
                    <ListItem>
                        <strong>d</strong> – maksymalna dobowa dawka
                        paracetamolu wyrażona w gramach (g),
                    </ListItem>
                    <ListItem>
                        <strong>m</strong> – masa ciała pacjenta wyrażona w
                        kilogramach (kg).
                    </ListItem>
                </UnorderedList>
                <br />
                <Text>
                    W przypadku dzieci do 12. roku życia maksymalna dawka nie
                    powinna przekraczać 2 g, a u dorosłych 4 g.
                </Text>
            </>
        ),
        sources: [
...

    {
        ...
        sources: [
            {
                id: 1,
                author: 'Medycyna Praktyczna',
                title: 'Tabela 2.6-8. Skala HAS-BLED do oceny ryzyka krwawienia u chorych z migotaniem przedsionków',
                dateOfAccess: new Date('2024-09-20'),
        ...
        form: [
            ...
            },
            {
                ...
                name: 'renalFunction',
                value: 1,
                label: 'Nieprawidłowa funkcja nerek: przewlekła dializoterapia, stan po przeszczepieniu nerki lub stężenie kreatyniny w surowicy powyżej 200 µmol/l (2.26 mg/dL)',
            },
            {
                type: 'checkbox',
                name: 'liverFunction',
                value: 1,
                label: 'Nieprawidłowa funkcja wątroby: przewlekła choroba wątroby lub biochemiczne cechy istotnego uszkodzenia wątroby',
            },
            {
                type: 'checkbox',
                name: 'stroke',
            ...
            },
            {
                ...
                value: 1,
                label: 'Predyspozycja do krwawienia i/lub poważne krwawienie w wywiadzie',
            },
            {
                type: 'checkbox',
                name: 'inrUnstable',
                value: 1,
                label: 'Niestabilne wartości INR - wahające się duże wartości lub często poza przedziałem terapeutycznym',
            },
            {
                type: 'checkbox',
                name: 'age',
...

    {
        ...
        form: [
            ...
            },
            {
                ...
                options: [
                    ...
                    {
                        value: 4,
                        label: 'Prawidłowa reakcja zgięciowa (wycofanie w odpowiedzi na bodziec bólowy)',
                    },
                    {
                        value: 3,
        ...
        calculateResult(formValues) {
            ...
            if (result >= 13)
                interpretation = 'Łagodne zaburzenia świadomości.';
        ...
        form: [
            {
                type: 'radioInput',
                name: 'interest',
                label: 'Jak często w ciągu ostatnich 2 tygodni dokuczało pacjentowi niewielkie zainteresowanie lub odczuwanie przyjemności z wykonywania czynności?',
                options: [
                    {
                        value: 0,
            ...
            },
            {
                type: 'radioInput',
                name: 'depression',
                label: 'Jak często w ciągu ostatnich 2 tygodni dokuczało pacjentowi uczucie smutku, przygnębienia lub beznadziejności?',
                options: [
                    {
                        value: 0,
                        label: 'Wcale nie dokuczało',
            ...
            },
            {
                type: 'radioInput',
                name: 'sleepProblems',
                label: 'Jak często w ciągu ostatnich 2 tygodni dokuczały pacjentowi kłopoty z zaśnięciem, przerywany sen albo zbyt długi sen?',
                options: [
                    {
                        value: 0,
            ...
            },
            {
                type: 'radioInput',
                name: 'energy',
                label: 'Jak często w ciągu ostatnich 2 tygodni dokuczało pacjentowi uczucie zmęczenia lub brak energii?',
                options: [
                    {
                        value: 0,
                        label: 'Wcale nie dokuczało',
            ...
            },
            {
                type: 'radioInput',
                name: 'appetite',
                label: 'Jak często w ciągu ostatnich 2 tygodni dokuczały pacjentowi brak apetytu lub przejadanie się?',
                options: [
                    {
                        value: 0,
                        label: 'Wcale nie dokuczały',
            ...
            },
            {
                type: 'radioInput',
                name: 'selfEsteem',
                label: 'Jak często w ciągu ostatnich 2 tygodni dokuczało pacjentowi poczucie niezadowolenia z siebie lub uczucie, że jest do niczego albo że zawiódł/zawiodła siebie lub rodzinę?',
                options: [
                    {
                        value: 0,
                        label: 'Wcale nie dokuczało',
            ...
            },
            {
                type: 'radioInput',
                name: 'concentration',
                label: 'Jak często w ciągu ostatnich 2 tygodni dokuczały pacjentowi problemy ze skupieniem się, na przykład przy czytaniu gazety lub oglądaniu telewizji?',
                options: [
                    {
                        value: 0,
                        label: 'Wcale nie dokuczały',
            ...
            },
            {
                type: 'radioInput',
                name: 'movement',
                label: 'Jak często w ciągu ostatnich 2 tygodni dokuczało pacjentowi spowolnienie albo niemożność usiedzenia w miejscu lub podenerwowanie powodujące ruchliwość znacznie większą niż zwykle?',
                options: [
                    {
                        value: 0,
                        label: 'Wcale nie dokuczało',
            ...
            },
            {
                ...
                label: 'Jak często w ciągu ostatnich 2 tygodni dokuczały pacjentowi myśli, że lepiej byłoby umrzeć albo chęć zrobienia sobie jakiejś krzywdy?',
                options: [
                    {
                        value: 0,
                        label: 'Wcale nie dokuczały',
...

    {
        ...
        methodology: (
            <>
                <Text>
                    Skorygowany odstęp QT (QTc) oblicza się za pomocą poniższego
                    wzoru:
                </Text>
                <br />
                ...
                <UnorderedList>
                    ...
                    <ListItem>
                        <strong>RR</strong> – odstęp RR w sekundach, który można
                        obliczyć jako 60 podzielone przez czynność serca (liczba
...

    {
        ...
        methodology: (
            <>
                <Text>
                    Wskaźnik Maddreya (DF, ang. <em>Discriminant Function</em>)
                    służy do oceny rokowania u pacjentów z alkoholowym
                    zapaleniem wątroby. Oblicza się go na podstawie czasu
                    protrombinowego, wartości referencyjnej oraz stężenia
                ...
                <UnorderedList>
                    <ListItem>
                        <strong>DF</strong> – wskaźnik rokowniczy (czynnik
                        dyskryminujący),
                    </ListItem>
                    <ListItem>
                        <strong>PT</strong> – czas protrombinowy pacjenta (w
                        sekundach),
                    </ListItem>
                    <ListItem>
                        <strong>CT</strong> – czas protrombinowy prawidłowy (w
                        sekundach),
                    </ListItem>
                    <ListItem>
                        <strong>B</strong> – stężenie bilirubiny całkowitej (w
                        mg/dl).
                    </ListItem>
                </UnorderedList>
                ...
                <br />
                <Text>
                    Wartość DF większa niż 32 sugeruje ciężki przebieg choroby i
                    może wskazywać na konieczność intensywniejszego leczenia.
                </Text>
            </>
        ),
        sources: [
        ...
        form: [
            {
                ...
                label: 'Czas protrombinowy pacjenta',
                unit: 's',
                min: 0.1,
                max: 1000,
            },
            {
                type: 'numberInput',
                name: 'controlTime',
                label: 'Czas protrombinowy prawidłowy',
                unit: 's',
                min: 0.1,
                max: 1000,
            },
            {
                type: 'numberInput',
                name: 'bilirubin',
                label: 'Stężenie bilirubiny całkowitej',
                unit: 'mg/dl',
                min: 0.1,
                max: 1000,
            },
...

    {
        ...
        methodology: (
            <>
                <Text>
                    Maksymalna dobowa dawka ibuprofenu u dorosłych nie powinna
                    przekraczać 3,2 g. U dzieci dawkę tę oblicza się na
                    podstawie masy ciała według poniższego wzoru:
                </Text>
                ...
                <UnorderedList>
                    <ListItem>
                        <strong>D</strong> – maksymalna dobowa dawka ibuprofenu
                        (w gramach),
                    </ListItem>
                    <ListItem>
                        <strong>M</strong> – masa ciała pacjenta (w
                        kilogramach).
                    </ListItem>
                </UnorderedList>
            </>
...

    {
        ...
        methodology: (
            <>
                <Text>
                    Skala PESI (ang. <em>Pulmonary Embolism Severity Index</em>)
                    służy do oceny ryzyka zgonu u pacjentów z ostrą zatorowością
                    płucną. Wartość wskaźnika oblicza się na podstawie wieku
                    pacjenta oraz obecności określonych czynników klinicznych,
                    którym przypisano punktację.
                </Text>
                ...
                <UnorderedList>
                    ...
                    <ListItem>
                        <strong>R</strong> – suma punktów przypisanych za
                        obecność poszczególnych czynników ryzyka.
                    </ListItem>
                </UnorderedList>

                <br />
                <Text>
                    Na podstawie końcowego wyniku pacjenta kwalifikuje się do
                    jednej z pięciu klas ryzyka (I–V), które pomagają w ocenie
                    rokowania i podejmowaniu decyzji terapeutycznych.
                </Text>
            </>
        ),
        sources: [
            {
                ...
                dateOfAccess: new Date('2024-09-26'),
        ...
        sources: [
            {
                id: 1,
                author: 'Medycyna Praktyczna',
                title: 'Tabela 2.33-9. Ocena prawdopodobieństwa klinicznego ZP wg zmodyfikowanej skali genewskiej',
                dateOfAccess: new Date('2024-09-30'),
        ...
        sources: [
            {
                id: 1,
                author: 'Medycyna Praktyczna',
                title: 'Rycina 3.13-2. Ocena ciężkości pozaszpitalnego zapalenia płuc u chorych w szpitalu – skala CURB-65',
                dateOfAccess: new Date('2024-09-30'),
...

    {
        ...
        methodology: (
            <>
                <Text>
                    Wskaźnik WHR (ang. <em>Waist-Hip Ratio</em>) jest miarą
                    rozmieszczenia tkanki tłuszczowej w organizmie i określa
                    proporcję obwodu talii do obwodu bioder. Stosuje się go w
                    ocenie ryzyka chorób sercowo-naczyniowych oraz
                    metabolicznych.
                </Text>
                ...
                <br />
                <Text>
                    Wyższe wartości WHR mogą wskazywać na otyłość brzuszną,
                    która wiąże się ze zwiększonym ryzykiem wystąpienia
                    nadciśnienia, cukrzycy typu 2 oraz chorób układu krążenia.
                </Text>
            </>
        ),
        sources: [
        ...
        calculateResult(formValues) {
            ...
            if (gender === 'male') {
                if (result >= 1)
                    interpretation = 'Otyłość androidalna (brzuszna).';
...

    {
        ...
        sources: [
            {
                ...
                dateOfAccess: new Date('2024-10-01'),
        ...
        form: [
            ...
            },
            {
                ...
                label: 'Czy pacjent ma trudności z powstrzymaniem się od palenia w miejscach, gdzie jest to zabronione?',
                options: [
                    {
                        value: 1,
                        label: 'Tak',
            ...
            },
            {
                ...
                label: 'Czy pacjent pali papierosy nawet podczas choroby, gdy musi leżeć w łóżku?',
                options: [
                    {
                        value: 1,
                        label: 'Tak',
        ...
        form: [
            {
                ...
                options: [
                    {
                        value: 1,
                        label: 'Bez ograniczeń w aktywności fizycznej. Zwykły wysiłek fizyczny nie powoduje nadmiernego zmęczenia, duszności ani kołatania serca',
                    },
                    {
                        value: 2,
                        label: 'Niewielkie ograniczenie aktywności fizycznej. Bez dolegliwości w spoczynku, ale zwykła aktywność powoduje zmęczenie, kołatanie serca lub duszność',
                    },
                    {
                        value: 3,
                        label: 'Znaczne ograniczenie aktywności fizycznej. Bez dolegliwości w spoczynku, ale aktywność mniejsza niż zwykła powoduje wystąpienie objawów',
                    },
                    {
                        value: 4,
                        label: 'Każda aktywność fizyczna wywołuje dolegliwości. Objawy podmiotowe niewydolności serca występują nawet w spoczynku, a jakakolwiek aktywność nasila dolegliwości',
                    },
                ],
            },
        ],
        ...
        sources: [
            {
                id: 1,
                author: 'Medycyna Praktyczna',
                title: 'Tabela 2.5-1. Klasyfikacja dławicy piersiowej na podstawie jej nasilenia wg Canadian Cardiovascular Society (CCS)',
                dateOfAccess: new Date('2024-10-01'),
        ...
        form: [
            {
                ...
                options: [
                    {
                        value: 1,
                        label: 'Zwyczajna aktywność fizyczna, taka jak chodzenie po płaskim terenie lub wchodzenie po schodach, nie wywołuje dławicy. Dławica występuje przy większym, gwałtowniejszym lub dłużej trwającym wysiłku fizycznym, związanym z pracą lub rekreacją',
                    },
                    {
                        value: 2,
                        label: 'Niewielkie ograniczenie zwyczajnej aktywności fizycznej. Dławica występuje przy szybkim chodzeniu po płaskim terenie lub szybkim wchodzeniu po schodach, przy wchodzeniu pod górę, przy chodzeniu po płaskim terenie lub wchodzeniu po schodach, po posiłkach, gdy jest zimno, wieje wiatr, pod wpływem stresu emocjonalnego lub tylko w ciągu kilku godzin po przebudzeniu lub po przejściu ponad 200 m po terenie płaskim i przy wchodzeniu po schodach na więcej niż jedno piętro w normalnym tempie i w zwykłych warunkach',
                    },
                    {
                        value: 3,
                        label: 'Znaczne ograniczenie zwykłej aktywności fizycznej. Dławica występuje po przejściu od 100 do 200 metrów po terenie płaskim lub przy wchodzeniu po schodach na jedno piętro w normalnym tempie i w zwykłych warunkach',
                    },
                    {
                        value: 4,
                        label: 'Jakakolwiek aktywność fizyczna wywołuje dławicę. Może ona występować w spoczynku',
                    },
                ],
            },
        ],
...

    {
        ...
        methodology: (
            <>
                <Text>
                    Wzór Cockcrofta–Gaulta służy do szacowania klirensu
                    kreatyniny (eGFR), który pozwala na ocenę czynności nerek.
                    Uwzględnia wiek pacjenta, masę ciała oraz stężenie
                    kreatyniny we krwi. Wartość ta pomaga dostosować dawki leków
                    wydalanych przez nerki i monitorować funkcję nerek.
                </Text>
                ...
                <UnorderedList>
                    <ListItem>
                        <strong>eGFR</strong> – szacowany klirens kreatyniny (w
                        ml/min),
                    </ListItem>
                    <ListItem>
                        <strong>A</strong> – wiek pacjenta (w latach),
                    ...
                    <ListItem>
                        <strong>C</strong> – stężenie kreatyniny w surowicy krwi
                        (w mg/dl).
                    </ListItem>
                </UnorderedList>
                ...
                <Text>
                    ...
                    współczynnik <strong>0,85</strong>, co pozwala uwzględnić
                    fizjologicznie niższą masę mięśniową w porównaniu do
                    mężczyzn.
                </Text>
            </>
        ),
        sources: [
            {
                ...
                dateOfAccess: new Date('2024-10-02'),
...

    {
        ...
        methodology: (
            <>
                <Text>
                    Wskaźnik FIB-4 jest narzędziem służącym do oceny stopnia
                    włóknienia wątroby u pacjentów z chorobami wątroby, takimi
                    jak wirusowe zapalenie wątroby typu C lub alkoholowe
                    uszkodzenie wątroby. Wartość FIB-4 jest obliczana na
                    podstawie wieku pacjenta, stężenia enzymów wątrobowych (ALT
                    i AST) oraz liczby płytek krwi.
                </Text>
                ...
                <Text>
                    ...
                    prawdopodobieństwo zaawansowanego włóknienia, natomiast
                    wartość poniżej <strong>1,45</strong> wskazuje na niskie
                    ryzyko obecności włóknienia.
                </Text>
            </>
        ),
        sources: [
            {
                ...
                dateOfAccess: new Date('2024-10-03'),
        ...
        calculateResult(formValues) {
            ...
            if (result > 3.25) {
                interpretation =
                    'Duże prawdopodobieństwo zaawansowanego włóknienia.';
...

    {
        ...
        sources: [
            {
                id: 1,
                author: 'Medycyna Praktyczna',
                title: 'Tabela 7.12-1. Klasyfikacja Childa (zmodyfikowana przez Pugha) niewydolności wątroby',
                dateOfAccess: new Date('2024-10-03'),
        ...
        calculateResult(formValues) {
            ...
            if (result >= 10) {
                interpretation =
                    'Klasa C. Są wskazania do przeszczepu wątroby.';
            } else if (result >= 7 && result < 10) {
                interpretation =
                    'Klasa B. Są wskazania do przeszczepu wątroby.';
...

    {
        ...
        sources: [
            {
                ...
                dateOfAccess: new Date('2024-10-14'),
            ...
            },
            {
                ...
                dateOfAccess: new Date('2024-10-16'),
        ...
        calculateResult(formValues) {
            ...
            if (result === 0) {
                ...
                if (result < 7.5) {
                    interpretation =
                        'Małe do umiarkowanego ryzyko w skali SCORE2-OP.';
                } else if (result < 15) {
                ...
                if (result < 5) {
                    interpretation =
                        'Małe do umiarkowanego ryzyko w skali SCORE2.';
                } else if (result < 10) {
...

    {
        ...
        methodology: (
            <>
                <Text>
                    Prognozowany wzrost dziecka można oszacować na podstawie
                    wzrostu rodziców, korzystając z uproszczonego wzoru
                    pediatrycznego. Pozwala on orientacyjnie określić, jaki
                    wzrost dziecko może osiągnąć w wieku dorosłym.
                </Text>
                ...
                <UnorderedList>
                    ...
                    <ListItem>
                        <strong>± 13</strong> – dodaj <strong>13 cm</strong> w
                        przypadku chłopców, odejmij <strong>13 cm</strong> w
                ...
                <br />
                <Text>
                    Należy pamiętać, że wzór ten dostarcza jedynie orientacyjnej
                    wartości i nie uwzględnia czynników genetycznych,
                    środowiskowych oraz zdrowotnych, które również wpływają na
                    wzrost dziecka.
                </Text>
            </>
        ),
        sources: [
            {
                ...
                dateOfAccess: new Date('2024-10-17'),
        ...
        sources: [
            {
                ...
                dateOfAccess: new Date('2024-10-20'),
        ...
        form: [
            {
                type: 'radioInput',
                name: 'euphoria',
                label: 'Czy kiedykolwiek zdarzyło się, że pacjent nie czuł się sobą i był w takiej euforii, że inni uważali, że nie jest sobą lub był w takiej euforii, że wdał się z tego powodu w kłopoty?',
                options: [
                    {
                        value: 1,
                        label: 'Tak',
            ...
            },
            {
                type: 'radioInput',
                name: 'nervousness',
                label: 'Czy kiedykolwiek zdarzyło się, że pacjent nie czuł się sobą i był tak poirytowany, że krzyczał na ludzi lub wdawał się z nimi w kłótnie?',
                options: [
                    {
                        value: 1,
                        label: 'Tak',
            ...
            },
            {
                type: 'radioInput',
                name: 'confidence',
                label: 'Czy kiedykolwiek zdarzyło się, że pacjent nie czuł się sobą i czuł się znacznie bardziej pewny siebie, niż zwykle?',
                options: [
                    {
                        value: 1,
                        label: 'Tak',
            ...
            },
            {
                type: 'radioInput',
                name: 'sleep',
                label: 'Czy kiedykolwiek zdarzyło się, że pacjent nie czuł się sobą i sypiał znacznie mniej niż zwykle, ale nie było to problemem?',
                options: [
                    {
                        value: 1,
                        label: 'Tak',
            ...
            },
            {
                type: 'radioInput',
                name: 'talkativeness',
                label: 'Czy kiedykolwiek zdarzyło się, że pacjent nie czuł się sobą i był znacznie bardziej rozmowny lub mówił szybciej, niż zwykle?',
                options: [
                    {
                        value: 1,
                        label: 'Tak',
            ...
            },
            {
                type: 'radioInput',
                name: 'rushOfThoughts',
                label: 'Czy kiedykolwiek zdarzyło się, że pacjent nie czuł się sobą i miał natłok myśli lub nie mógł zwolnić toku myśli?',
                options: [
                    {
                        value: 1,
                        label: 'Tak',
            ...
            },
            {
                type: 'radioInput',
                name: 'concentration',
                label: 'Czy kiedykolwiek zdarzyło się, że pacjent nie czuł się sobą i tak łatwo rozpraszał się rzeczami wokół, że miał problem z koncentracją i kontynuowaniem zadania?',
                options: [
                    {
                        value: 1,
                        label: 'Tak',
            ...
            },
            {
                type: 'radioInput',
                name: 'energy',
                label: 'Czy kiedykolwiek zdarzyło się, że pacjent nie czuł się sobą i miał znacznie więcej energii niż zazwyczaj?',
                options: [
                    {
                        value: 1,
                        label: 'Tak',
            ...
            },
            {
                type: 'radioInput',
                name: 'activity',
                label: 'Czy kiedykolwiek zdarzyło się, że pacjent nie czuł się sobą i był znacznie bardziej aktywny lub robił znacznie więcej, niż zazwyczaj?',
                options: [
                    {
                        value: 1,
                        label: 'Tak',
            ...
            },
            {
                type: 'radioInput',
                name: 'sociability',
                label: 'Czy kiedykolwiek zdarzyło się, że pacjent nie czuł się sobą i znacznie bardziej niż zwykle udzielał się towarzysko, np. dzwonił do znajomych w środku nocy?',
                options: [
                    {
                        value: 1,
                        label: 'Tak',
            ...
            },
            {
                type: 'radioInput',
                name: 'sexuality',
                label: 'Czy kiedykolwiek zdarzyło się, że pacjent nie czuł się sobą i był znacznie bardziej zainteresowany seksem niż zazwyczaj?',
                options: [
                    {
                        value: 1,
                        label: 'Tak',
            ...
            },
            {
                type: 'radioInput',
                name: 'riskyBehavior',
                label: 'Czy kiedykolwiek zdarzyło się, że pacjent nie czuł się sobą i robił rzeczy nietypowe dla siebie lub takie, które inni uznawali za przesadne, głupie lub ryzykowne?',
                options: [
                    {
                        value: 1,
                        label: 'Tak',
            ...
            },
            {
                type: 'radioInput',
                name: 'moneySpending',
                label: 'Czy kiedykolwiek zdarzyło się, że pacjent nie czuł się sobą i wydawanie pieniędzy przysporzyło jemu lub jego rodzinie kłopotów?',
                options: [
                    {
                        value: 1,
                        label: 'Tak',
            ...
            },
            {
                ...
                label: 'Jeśli pacjent odpowiedział "tak" na 7 lub więcej pytań powyżej, czy kilka z powyższych objawów kiedykolwiek wystąpiło w tym samym czasie?',
                options: [
                    {
                        value: 'true',
                        label: 'Tak',
            ...
            },
            {
                type: 'radioInput',
                name: 'problem',
                label: 'Na ile problematyczne były dla pacjenta powyższe objawy, np. w pracy, rodzinie, zarabianiu pieniędzy, kłopotach z prawem lub wdawaniu się w kłótnie i bójki?',
                options: [
                    {
                        value: 'no',
                        label: 'Bez problemu',
...

    {
        ...
        sources: [
            {
                ...
                dateOfAccess: new Date('2024-10-22'),
        ...
        form: [
            ...
            },
            {
                type: 'radioInput',
                name: 'amount',
                label: 'Ile standardowych porcji alkoholu pacjent wypija w typowym dniu, gdy spożywa alkohol? Jedna standardowa porcja to 10 g czystego alkoholu, np. 250 ml piwa o mocy 5%, 100 ml wina o mocy 12% lub 30 ml wódki o mocy 40%',
                options: [
                    {
                        value: 0,
            ...
            },
            {
                type: 'radioInput',
                name: 'amountPerDay',
                label: 'Jak często pacjent wypija co najmniej 6 porcji alkoholu podczas jednego dnia?',
                options: [
                    {
                        value: 0,
                        label: 'Nigdy',
            ...
            },
            {
                ...
                label: 'Jak często w ostatnim roku pacjent nie mógł przerwać picia po jego rozpoczęciu?',
                options: [
                    {
                        value: 0,
                        label: 'Nigdy',
            ...
            },
            {
                ...
                label: 'Jak często w ciągu ostatniego roku z powodu picia pacjent zrobił coś niewłaściwego, niezgodnego z przyjętymi w jego środowisku normami postępowania?',
                options: [
                    {
                        value: 0,
                        label: 'Nigdy',
            ...
            },
            {
                ...
                label: 'Jak często w ostatnim roku pacjent musiał napić się alkoholu rano, aby móc dojść do siebie po intensywnym piciu poprzedniego dnia?',
                options: [
                    {
                        value: 0,
                        label: 'Nigdy',
            ...
            },
            {
                type: 'radioInput',
                name: 'remorse',
                label: 'Jak często w ostatnim roku pacjent miał poczucie winy lub wyrzuty sumienia po spożyciu alkoholu?',
                options: [
                    {
                        value: 0,
                        label: 'Nigdy',
            ...
            },
            {
                type: 'radioInput',
                name: 'memory',
                label: 'Jak często w ostatnim roku z powodu picia pacjent nie mógł sobie przypomnieć, co zdarzyło się poprzedniego dnia?',
                options: [
                    {
                        value: 0,
                        label: 'Nigdy',
            ...
            },
            {
                type: 'radioInput',
                name: 'injury',
                label: 'Czy pacjent lub ktoś inny kiedykolwiek doznał urazu fizycznego z powodu jego picia?',
                options: [
                    {
                        value: 0,
                        label: 'Nie',
            ...
            },
            {
                type: 'radioInput',
                name: 'signaling',
                label: 'Czy ktoś z rodziny, lekarz lub inny pracownik ochrony zdrowia interesował się piciem pacjenta lub sugerował jego ograniczenie?',
                options: [
                    {
                        value: 0,
                        label: 'Nie',
        ...
        sources: [
            {
                ...
                dateOfAccess: new Date('2024-10-23'),
        ...
        sources: [
            {
                ...
                dateOfAccess: new Date('2024-10-27'),
        ...
        form: [
            {
                ...
                options: [
                    ...
                    {
                        value: 5,
                        label: 'Potrzebuje pomocy w krojeniu, smarowaniu, karmieniu doustnym',
                    },
                    {
                        value: 10,
            ...
            },
            {
                ...
                options: [
                    {
                        value: 0,
                        label: 'Nie jest w stanie się przemieszczać, nie zachowuje równowagi przy siadaniu oraz siedzeniu',
                    },
                    {
                        value: 5,
                        label: 'Przemieszcza się z pomocą fizyczną jednej lub dwóch osób, może siedzieć',
                    },
                    {
                        value: 10,
            ...
            },
            {
                ...
                options: [
                    ...
                    {
                        value: 10,
                        label: 'Samodzielny przy myciu twarzy, czesaniu się, myciu zębów, także z zapewnionymi pomocami',
                    },
                ],
            },
            {
                ...
                options: [
                    ...
                    {
                        value: 5,
                        label: 'Potrzebuje lub częściowo potrzebuje pomocy przy korzystaniu z toalety',
                    },
                    {
                        value: 10,
                        label: 'Samodzielny w dotarciu do toalety oraz w zdejmowaniu i zakładaniu części garderoby',
                    },
                ],
            },
            {
            ...
            },
            {
                ...
                options: [
                    ...
                    {
                        value: 5,
                        label: 'Porusza się na odległość do 50 m za pomocą sprzętu wspomagającego i z pomocą co najmniej jednej osoby',
                    },
                    {
                        value: 10,
                        label: 'Samodzielny, niezależny w poruszaniu się na odległość powyżej 50m, także w użyciem sprzętu wspomagającego',
                    },
                ],
            },
            {
                ...
                options: [
                    {
                        value: 0,
                        label: 'Nie jest w stanie wchodzić i schodzić po schodach nawet z pomocą innej osoby',
                    },
                    {
                        value: 5,
            ...
            },
            {
                ...
                options: [
                    ...
                    {
                        value: 10,
                        label: 'Samodzielny, niezależny (także w zapinaniu guzików, zamka, zawiązywaniu sznurowadeł)',
                    },
                ],
            },
            {
...

    {
        ...
        methodology: (
            <>
                <Text>
                    Wzór Erika Widmarka służy do szacunkowego obliczenia
                    stężenia alkoholu we krwi (BAC –
                    <em>Blood Alcohol Concentration</em>) na podstawie ilości
                    spożytego alkoholu, masy ciała oraz płci.
                </Text>
                ...
                <UnorderedList>
                    <ListItem>
                        <strong>BAC</strong> – szacowane stężenie alkoholu we
                        krwi (w ‰),
                    </ListItem>
                    <ListItem>
                        <strong>A</strong> – ilość spożytego czystego alkoholu
                        (w gramach),
                    </ListItem>
                    <ListItem>
                ...
                <Text>
                    ...
                    indywidualnych różnic w metabolizmie, stanie zdrowia czy
                    sposobie spożywania alkoholu.
                </Text>
            </>
        ),
        sources: [
            {
                ...
                dateOfAccess: new Date('2024-10-28'),
        ...
        form: [
            ...
            },
            {
                ...
                label: 'Ilość wypitego czystego alkoholu w gramach (1 ml czystego alkoholu to 0,8 g)',
                min: 1,
                max: 1000,
            },
        ],
        ...
        sources: [
            {
                ...
                dateOfAccess: new Date('2024-10-29'),
...

    {
        ...
        sources: [
            {
                ...
                dateOfAccess: new Date('2024-11-15'),
        ...
        form: [
            {
                type: 'radioInput',
                name: 's',
                label: 'Czy pacjent chrapie na tyle głośno, że słychać to przez zamknięte drzwi lub partner/ka szturcha go przez to w nocy?',
                options: [
                    {
                        value: 1,
                        label: 'Tak',
            ...
            },
            {
                type: 'radioInput',
                name: 't',
                label: 'Czy pacjent często czuje się zmęczony, wyczerpany lub śpiący w ciągu dnia?',
                options: [
                    {
                        value: 1,
                        label: 'Tak',
            ...
            },
            {
                type: 'radioInput',
                name: 'o',
                label: 'Czy ktoś zaobserwował u pacjenta przerwy w oddychaniu, krztuszenie się lub dławienie w czasie snu?',
                options: [
                    {
                        value: 1,
                        label: 'Tak',
        ...
        calculateResult(formValues) {
            ...
            if (result >= 5 || isHighRisk) {
                ...
                interpretation =
                    'Umiarkowane ryzyko obturacyjnego bezdechu sennego.';
            } else {
                interpretation =
        ...
        sources: [
            {
                ...
                dateOfAccess: new Date('2025-01-15'),
                link: 'https://www.mp.pl/neurologia/udar-mozgu/195346,2-ocena-kliniczna-i-leczenie-w-warunkach-stanu-naglacego',
            },
            {
                id: 2,
                author: 'Shenzhen Traditional Chinese Medicine Hospital (Yuanyuan Zhuo, Yimin Qu, Jiaman Wu, Xingxian Huang, Weiqu Yuan, Jack Lee, Zhuoxin Yang, Benny Zee)',
...

    {
        ...
        methodology: (
            <>
                <Text>
                    Beztłuszczowa masa ciała (LBM – <em>Lean Body Mass</em>) to
                    masa organizmu po odjęciu tkanki tłuszczowej. Jest to
                    istotny wskaźnik w ocenie składu ciała, wykorzystywany do
                    monitorowania postępów w redukcji masy tłuszczowej lub w
                    budowaniu masy mięśniowej.
                </Text>

                <br />
                <Text>
                    Wzór do obliczenia LBM jest różny dla kobiet i mężczyzn:
                </Text>
                ...
                <br />
                <Text>
                    Wzory te oparte są na badaniach populacyjnych i stanowią
                    przybliżenie, które może być wykorzystywane u dorosłych w
                    celu orientacyjnego oszacowania beztłuszczowej masy ciała.
                </Text>
            </>
        ),
        sources: [
            {
                ...
                dateOfAccess: new Date('2025-07-01'),
...

    {
        ...
        methodology: (
            <>
                <Text>
                    Skala klinicznego prawdopodobieństwa choroby wieńcowej (CAD
                    – Coronary Artery Disease) została opracowana przez
                    Europejskie Towarzystwo Kardiologiczne (ESC) i służy do
                    oceny prawdopodobieństwa istotnej ChW u pacjentów z
                ...
                <UnorderedList>
                    ...
                    <ListItem>
                        Liczbę czynników ryzyka (wywiad rodzinny, nikotynizm,
                        dyslipidemia, nadciśnienie tętnicze, cukrzyca),
                    </ListItem>
                    <ListItem>Wiek i płeć pacjenta.</ListItem>
                </UnorderedList>
                <br />
                <Text>
                    Końcowy wynik obliczany jest na podstawie tabeli
                    prawdopodobieństwa CAD, która przypisuje wartości punktowe w
                    zależności od kombinacji powyższych czynników. Przykładowa
                    tabela znajduje się na stronie nr 25 w dokumencie PDF
                    załączonym w źródłach.
                </Text>
            </>
        ),
        sources: [
            {
                ...
                dateOfAccess: new Date('2025-11-03'),
                link: 'https://www.mp.pl/interna/table/B16.2.5-2.',
            },
            {
                id: 2,
                author: 'European Society of Cardiology (ESC)',
                title: '2024 ESC Guidelines for the management of chronic coronary syndromes (dokument PDF)',
                dateOfAccess: new Date('2025-11-03'),
        ...
        form: [
            ...
            },
            {
                ...
                value: 1,
                label: 'Choroba wieńcowa w wywiadzie rodzinnym (krewny pierwszego stopnia z wczesnymi objawami: kobieta poniżej 65 r.ż., mężczyzna poniżej 55 r.ż.)',
                hideBadge: true,
            },
            {
                type: 'checkbox',
        ...
        calculateResult(formValues) {
            ...
            const result = cadProbabilityTable[
                mainSymptomValue as MainSymptomValue
            ][gender as Sex][ageGroup as AgeGroup][riskFactorGroup] as number;

            let interpretation: string = '';

            if (result <= 5) {
                interpretation =
                    'Bardzo niskie prawdopodobieństwo choroby wieńcowej.';
            } else if (result <= 15) {
        ...
        sources: [
            {
                id: 1,
                author: 'Medycyna Praktyczna',
                title: 'Tabela 2.6-7. Skala CHA2DS2-VA do oceny ryzyka udaru niedokrwiennego mózgu u chorych z migotaniem przedsionków niezwiązanym z wadą zastawkową (Portal lekarzy)',
                dateOfAccess: new Date('2026-02-21'),
